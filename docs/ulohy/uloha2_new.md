...
- Vytvoříme nový projekt, nahrajeme databázi zemí (_add data_), souřadnicovou síť a tabulku s body - vše viz _Zdroje dat_.
...
-Technická zpráva – zadání, postup prací, potřebné matematické formulace, souřadnice vstupující do výpočtů, tabulka porovnávající výsledky ručního výpočtu a výpočtu z PROJ (do obou postupů musí vcházet souřadnice se stejnou přesností, porovnávané hodnoty zaokrouhlovat na stejný počet desetinných míst), závěr (včetně informace o velikosti vytvořeného modelu).
